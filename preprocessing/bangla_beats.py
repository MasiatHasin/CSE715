...
# CONFIG
# =========================
DATASET_DIR = "raw_data/bangla_beats_merged"
OUT_PKL = "data/bangla_features.pkl"
...
# CONVERT TO NUMPY
# =========================
X = np.vstack(features)                  # (N, 40)
genres = np.array(genres)                # (N,)
paths = np.array(paths, dtype=object)    # (N,)
